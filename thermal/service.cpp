...
static int shutdown() {
    LOG(ERROR) << "Xiaomi SDM660 Thermal HAL Service is shutting down.";
    return 1;
}
...
int main(int /* argc */, char ** /* argv */) {
    ...
    LOG(INFO) << "Xiaomi SDM660 Thermal HAL Service 2.0 starting...";
    ...
    LOG(INFO) << "Xiaomi SDM660 Thermal HAL Service 2.0 started successfully.";
    joinRpcThreadpool();
